...
function removeBlink() {
	$("#teller1").removeClass("pressBlink");
}

function getDataTeller1() {
	$.ajax({
			type: 'POST',
			url: 'get_data.php',
			data: { queue_id:2},
			...
			success: function (d) {
				...
				$("#teller1").text(pData.q_no);
				$("#teller1").addClass("pressBlink");
...
<table width="100%" id="tblHdr">
	<tr width="100%">
		...
		<td width="50%"><h1 style="font-size:80px">TELLER 1</h1></td>
	</tr>
</table>
<table width="100%" id="tblBody">
	<tr width="100%">
		<td width="40%" id="teller1" align="right" style="font-size:400px;font-weight:bold;" >
		</td>
