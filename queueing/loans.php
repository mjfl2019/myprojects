...
function removeBlink() {
	$("#loans1").removeClass("pressBlink");
}

function getDataLoans1() {
	$.ajax({
			type: 'POST',
			url: 'get_data.php',
			data: { queue_id:4},
			...
			success: function (d) {
				...
				$("#loans1").text(pData.q_no);
				$("#loans1").addClass("pressBlink");
...
<table width="100%" id="tblHdr">
	<tr width="100%">
		...
		<td width="50%"><h1 style="font-size:80px">LOANS 1</h1></td>
	</tr>
</table>
<table width="100%" id="tblBody">
	<tr width="100%">
		<td width="40%" id="loans1" align="right" style="font-size:400px;font-weight:bold;" >
		</td>
