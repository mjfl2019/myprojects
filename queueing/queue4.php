...
<header>
	...
	<table width="100%" id="tblHdr">
		<tr width="100%">
			...
			<td width="70%"><h1 id="hAnimate" style="font-size:60px">NOW SERVING</h1></td>
		</tr>
	</table>
</header>
<section>
			...
			<td width="40%">
				<table width="100%" id="tblContent">
					<tr>
						...
						<td width="20%" align="center"><p id="pNewAcct" style="font-size:55px;"><b>1</b></p></td>
					</tr>
					<tr>
						<td width="80%" align="center"><p style="font-size:50px;"><b>TELLER 1</b></p></td>
						<td width="20%" align="center"><p id="pTeller" style="font-size:55px;"><b>1</b></p></td>
					</tr>
					<tr>
						<td width="80%" align="center"><p style="font-size:50px;"><b>TELLER 2</b></p></td>
						<td width="20%" align="center"><p id="pTeller2" style="font-size:55px;"><b>1</b></p></td>
					</tr>
					<tr>
						<td width="80%" align="center"><p style="font-size:50px;"><b>LOANS 1</b></p></td>
						<td width="20%" align="center"><p id="pLoans" style="font-size:55px;"><b>1</b></p></td>
					</tr>
					<tr>
						<td width="80%" align="center"><p style="font-size:50px;"><b>LOANS 2</b></p></td>
						<td width="20%" align="center"><p id="pLoans2" style="font-size:55px;"><b>1</b></p></td>
					</tr>
				</table>
			</td>
			<td width="60%" align="center">
				<video id="cbpVideo" width="97%" controls loop autoplay="true" muted="muted">
					<source src="video/cbpadsnew2.mp4" type="video/mp4">
