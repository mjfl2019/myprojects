...
function removeBlink() {
	$("#teller2").removeClass("pressBlink");
}

function getDataTeller2() {
	$.ajax({
			type: 'POST',
			url: 'get_data.php',
			data: { queue_id:3},
			...
			success: function (d) {
				...
				$("#teller2").text(pData.q_no);
				$("#teller2").addClass("pressBlink");
...
<table width="100%" id="tblHdr">
	<tr width="100%">
		...
		<td width="50%"><h1 style="font-size:80px">TELLER 2</h1></td>
	</tr>
</table>
<table width="100%" id="tblBody">
	<tr width="100%">
		<td width="40%" id="teller2" align="right" style="font-size:400px;font-weight:bold;" >
		</td>
